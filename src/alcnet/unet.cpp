...
void tUnet::init() {
	...
	receiveAhead=10; // Receive up to 10 not-yet acceptable packets "in the future" from the last acked packet we got
	...
	lim_down_cap=15000; //in bytes
	lim_up_cap=15000; //in bytes
	in_noise=5; //(0-100)
	out_noise=5; //(0-100)

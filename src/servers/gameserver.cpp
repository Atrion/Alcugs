...
namespace alc {
	...
	void tUnetGameServer::terminate(tNetSession *u, Byte reason, bool gotLeave)
	{
		...
		tUnetLobbyServerBase::terminate(u, reason, gotLeave); // do the lobbybase terminate procedure
	}

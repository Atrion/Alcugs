...
/**********************************************
  Temporany file to store the currently used config vars,
	not used by the new netcore
*************************************************/

#ifndef __U_TMP_CONFIG_H_
#define __U_TMP_CONFIG_H_
#define __U_TMP_CONFIG_H_ID "$Id$"
...
----------------------------------------------------*/
int get_config(FILE * dsc, char * address);
